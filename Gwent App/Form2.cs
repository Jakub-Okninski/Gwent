...
namespace Gwent_App
{
    public partial class Form2 : Form
    {
        ...
        public void setForm(Game g, Form1 f)
        {
            player1 = g.player2;
            player2 = g.player1;
            game = g;
        ...
        private void Panel_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (pictureBox != null && targetPanel != null && targetPanel != sourcePanel)
            {
                ...
                if (c is Pozoga)
                {
                    ...
                    FilterPanelPozoga(form1.panelZwarcieGracz1, player2.playerBoard.CardsPiechotyPlayer);
                    FilterPanelPozoga(form1.panelZwarcieGracz2, player1.playerBoard.CardsPiechotyPlayer);
                    FilterPanelManekin(form1.panelZwarcieGracz1, player2.playerBoard, LocationCard.Piechoty);
                    FilterPanelManekin(form1.panelZwarcieGracz2, player1.playerBoard, LocationCard.Piechoty);

                    FilterPanelPozoga(form1.panelDystansGracz2, player1.playerBoard.CardsStrzeleckiePlayer);
                    FilterPanelPozoga(form1.panelDystansGracz1, player2.playerBoard.CardsStrzeleckiePlayer);
                    FilterPanelManekin(form1.panelDystansGracz1, player2.playerBoard, LocationCard.Lucznika);
                    FilterPanelManekin(form1.panelDystansGracz2, player1.playerBoard, LocationCard.Lucznika);

                    FilterPanelPozoga(form1.panelOblezniczeGracz1, player2.playerBoard.CardsOblezniczePlayer);
        ...
        private void RefreshScores()
        {
            ...
            form1.labelDystansGracz2.Text = player1.playerBoard.PointsStrzeleckie + "";
            form1.labelZwarcieGracz2.Text = player1.playerBoard.PointsPiechoty + "";
            form1.labelOblezniczeGracz2.Text = player1.playerBoard.PointsObleznicze + "";
            form1.labelPunktySumaGracz2.Text = player1.playerBoard.PointsSum + "";

            form1.labelDystansGracz1.Text = player2.playerBoard.PointsStrzeleckie + "";
            form1.labelZwarcieGracz1.Text = player2.playerBoard.PointsPiechoty + "";
            form1.labelOblezniczeGracz1.Text = player2.playerBoard.PointsObleznicze + "";
            form1.labelPunktySumaGracz1.Text = player2.playerBoard.PointsSum + "";
            ...
            UpdateCardForcePanel(form1.panelZwarcieGracz1);
            UpdateCardForcePanel(form1.panelDystansGracz1);
            UpdateCardForcePanel(form1.panelOblezniczeGracz1);
            UpdateCardForcePanel(form1.panelZwarcieGracz2);
            UpdateCardForcePanel(form1.panelDystansGracz2);
            UpdateCardForcePanel(form1.panelOblezniczeGracz2);
