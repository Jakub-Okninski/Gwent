namespace Gwent_App
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            panelDystansGracz1 = new Panel();
            panelOblezniczeGracz1 = new Panel();
            panelZwarcieGracz1 = new Panel();
            panelOblezniczeGracz2 = new Panel();
            panelDystansGracz2 = new Panel();
            panelZwarcieGracz2 = new Panel();
            labelOblezniczeGracz1 = new Label();
            labelDystansGracz1 = new Label();
            labelZwarcieGracz1 = new Label();
            labelZwarcieGracz2 = new Label();
            labelDystansGracz2 = new Label();
            labelOblezniczeGracz2 = new Label();
            panelGracza = new Panel();
            panelSpecjalnaGracz1 = new Panel();
            panelSpecjalnaGracz2 = new Panel();
            pictureBoxZdjecieGracz1 = new PictureBox();
            ...
            backgroundPictureBox.Size = new Size(1620, 900);
            ...
            labelImieGracz1.Text = "Imie";
            // 
            // labelImieGracz2
            // 
            labelImieGracz2.AutoSize = true;
            labelImieGracz2.Location = new Point(154, 207);
            labelImieGracz2.Name = "labelImieGracz2";
